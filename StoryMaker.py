...
if st.button("สร้างนิทาน"):
    if not keywords:
        ...
        thai_prompt = f"เขียนนิทานไม่เกิน 15 บรรทัดโดยใช้คำต่อไปนี้: {keywords} และให้มีสไตล์ {style} โดยนิทานต้องมีเนื้อเรื่องที่สมเหตุสมผล คำนึงถึงองค์ประกอบละครทั้ง 6 ของอริสโตเติล ไม่ซับซ้อนเกินไป และใช้ภาษาที่สละสลวย"
